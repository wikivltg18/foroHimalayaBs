                    ...
                    <div class="container-fluid mt-3">
                        <div class="col-md-12">
                            <button class="btn btn-light d-md-none m-3" id="toggleSidebar">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#003B7B" viewBox="0 0 16 16">
                                ...
                                <div class="row p-3 d-flex h-100">
                                        <div class="col-md-6 col-sm-10 ">
                                                <ol class="breadcrumb m-0">
                                                    <li><a href="/dashboard" class="text-muted text-decoration-none" style="font-weight: 500;"><span>Inicio / </a>{{ $titulo ?? '' }}</li>
                                                </ol>
                                            <div class="title">
