<x-app-layout>
                ...
                <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-4">
                            <button type="submit" class="btn btn-success w-100" id="btnActualizarCliente">Actualizar cliente</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            // -------- Elementos --------
            const btnGuardar = document.getElementById('btnActualizarCliente');
